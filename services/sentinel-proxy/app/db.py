"""
Async-friendly Oracle 26ai connection pool wrapper for the Sentinel Proxy.
Same shape as the AIS Multiplexer / Jamming Poller — kept duplicated rather
than factored into a shared library while the platform is still small
enough that copy-paste-with-context is cheaper than premature abstraction.
"""
