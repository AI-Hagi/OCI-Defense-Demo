"""
Async-friendly Oracle 26ai connection pool wrapper for the Jamming Poller.

Mirrors the pattern from services/ais-multiplexer/app/db.py: oracledb is sync,
we wrap acquire+execute in asyncio.to_thread to keep the FastAPI event loop free.
"""
